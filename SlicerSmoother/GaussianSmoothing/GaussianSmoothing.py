...
class GaussianSmoothing(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "Gaussian Smoothing"
    self.parent.categories = ["Examples"]
    self.parent.dependencies = []
    self.parent.contributors = ["Zachary Harmany (UC Davis)"]
    self.parent.helpText = """
    This is an example of a module for performing Gaussian smoothing.
    """
...
#    cliNode = slicer.cli.run(slicer.modules.thresholdscalarvolume, None, cliParams, wait_for_completion=True)
    ...
    if enableScreenshots:
      self.takeScreenshot('GaussianSmoothingTest-Start','MyScreenshot',-1)
...
class GaussianSmoothingTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_GaussianSmoothing1()

  def test_GaussianSmoothing1(self):
